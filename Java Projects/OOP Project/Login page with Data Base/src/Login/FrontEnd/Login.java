...
import Login.BackEndLogic.InsertLogic;
            ...
            public void actionPerformed(ActionEvent e) {
               try {
                   ...
                   || ageT.getText().isEmpty() || semT.getText().isEmpty()){
                       ...
                       InsertLogic l1 = new InsertLogic();
                       l1.AddAccount(newaccountbutton,panel,accountpanel,idT,frstT,lastT,userT,passT,ageT,semT,termsCheckB);
                   }
